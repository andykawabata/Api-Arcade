...
/*
*Last updated on 11/28/20
*
*Test class to remove small words and punctuation from a string array
*
...
public class Sanitizer {
    ...
    /**
     * @param _array an array of strings obtained from a sentence split by
     * spaces
    ...
    /**
     * @param _array an array of strings obtained from a sentence split by
     * spaces punctuation should have been removed from any of the strings prior
     * to to this method being called
     * @return an array of strings that contains no strings smaller than 4
     * letters returns null if any string contains punctuation
     */
